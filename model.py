...
from config import ticker_info


def get_round_num(ticker):
    if ticker_info.get(ticker)[0] < 100:
        round_num = 2
    elif ticker_info.get(ticker)[0] < 10000:
        round_num = 4
    else:
        round_num = 6
    return round_num
...
class Model():
    def __init__(self, stock):
        ...
        self.stock = stock # Stock это код акции которая будет предсказываться
